...
namespace _boldui_protocol {
    ...
    public sealed class A2RHelloResponse: IEquatable<A2RHelloResponse>, ICloneable {
        ...
        public A2RHelloResponse(ushort _protocol_major_version, ushort _protocol_minor_version, uint _extra_len, Serde.Option<Error> _error) {
        ...
        public static A2RHelloResponse Deserialize(Serde.IDeserializer deserializer) {
            deserializer.increase_container_depth();
            A2RHelloResponse obj = new A2RHelloResponse(
        ...
        public static A2RHelloResponse BincodeDeserialize(byte[] input) => BincodeDeserialize(new ArraySegment<byte>(input));

        public static A2RHelloResponse BincodeDeserialize(ArraySegment<byte> input) {
            if (input == null) {
                 throw new Serde.DeserializationException("Cannot deserialize null array");
            }
            Serde.IDeserializer deserializer = new Bincode.BincodeDeserializer(input);
            A2RHelloResponse value = Deserialize(deserializer);
            if (deserializer.get_buffer_offset() < input.Count) {
                 throw new Serde.DeserializationException("Some input bytes were not read");
            }
            return value;
        }
        public override bool Equals(object obj) => obj is A2RHelloResponse other && Equals(other);

        public static bool operator ==(A2RHelloResponse left, A2RHelloResponse right) => Equals(left, right);

        public static bool operator !=(A2RHelloResponse left, A2RHelloResponse right) => !Equals(left, right);

        public bool Equals(A2RHelloResponse other) {
        ...
        public A2RHelloResponse Clone() => (A2RHelloResponse)MemberwiseClone();
