...
namespace _boldui_protocol {
    ...
    public sealed class R2AHello: IEquatable<R2AHello>, ICloneable {
        ...
        public R2AHello(ushort _min_protocol_major_version, ushort _min_protocol_minor_version, ushort _max_protocol_major_version, uint _extra_len) {
        ...
        public static R2AHello Deserialize(Serde.IDeserializer deserializer) {
            deserializer.increase_container_depth();
            R2AHello obj = new R2AHello(
        ...
        public static R2AHello BincodeDeserialize(byte[] input) => BincodeDeserialize(new ArraySegment<byte>(input));

        public static R2AHello BincodeDeserialize(ArraySegment<byte> input) {
            if (input == null) {
                 throw new Serde.DeserializationException("Cannot deserialize null array");
            }
            Serde.IDeserializer deserializer = new Bincode.BincodeDeserializer(input);
            R2AHello value = Deserialize(deserializer);
            if (deserializer.get_buffer_offset() < input.Count) {
                 throw new Serde.DeserializationException("Some input bytes were not read");
            }
            return value;
        }
        public override bool Equals(object obj) => obj is R2AHello other && Equals(other);

        public static bool operator ==(R2AHello left, R2AHello right) => Equals(left, right);

        public static bool operator !=(R2AHello left, R2AHello right) => !Equals(left, right);

        public bool Equals(R2AHello other) {
        ...
        public R2AHello Clone() => (R2AHello)MemberwiseClone();
