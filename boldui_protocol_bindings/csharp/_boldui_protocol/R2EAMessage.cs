...
namespace _boldui_protocol {
    ...
    public abstract class R2EAMessage: IEquatable<R2EAMessage>, ICloneable {

        public abstract void Serialize(Serde.ISerializer serializer);

        public static R2EAMessage Deserialize(Serde.IDeserializer deserializer) {
            int index = deserializer.deserialize_variant_index();
            switch (index) {
                case 0: return Update.Load(deserializer);
                case 1: return Open.Load(deserializer);
                case 2: return Error.Load(deserializer);
                default: throw new Serde.DeserializationException("Unknown variant index for R2EAMessage: " + index);
            }
        }
        ...
        public static R2EAMessage BincodeDeserialize(byte[] input) => BincodeDeserialize(new ArraySegment<byte>(input));

        public static R2EAMessage BincodeDeserialize(ArraySegment<byte> input) {
            if (input == null) {
                 throw new Serde.DeserializationException("Cannot deserialize null array");
            }
            Serde.IDeserializer deserializer = new Bincode.BincodeDeserializer(input);
            R2EAMessage value = Deserialize(deserializer);
        ...
        public override bool Equals(object obj) => obj is R2EAMessage other && Equals(other);

        public bool Equals(R2EAMessage other) {
        ...
        public R2EAMessage Clone() => (R2EAMessage)MemberwiseClone();

        object ICloneable.Clone() => Clone();


        public sealed class Update: R2EAMessage, IEquatable<Update>, ICloneable {
            public R2EAUpdate value;

            public Update(R2EAUpdate _value) {
            ...
            internal static Update Load(Serde.IDeserializer deserializer) {
                ...
                Update obj = new Update(
                	R2EAUpdate.Deserialize(deserializer));
        ...
        public sealed class Open: R2EAMessage, IEquatable<Open>, ICloneable {
            public R2EAOpen value;

            public Open(R2EAOpen _value) {
                if (_value == null) throw new ArgumentNullException(nameof(_value));
                value = _value;
            }
            ...
            internal static Open Load(Serde.IDeserializer deserializer) {
                deserializer.increase_container_depth();
                Open obj = new Open(
                	R2EAOpen.Deserialize(deserializer));
                deserializer.decrease_container_depth();
                return obj;
            }
        ...
        public sealed class Error: R2EAMessage, IEquatable<Error>, ICloneable {
